...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Pokrećem activation test sa parametrima:\n"
              << " batch=" << batch
              << " H=" << H
              << " W=" << W
    ...
    // Kreiranje Tensor objekata (NHWC)
    ...
    // --- Gradnja mreže ---
    ActivationBuilder actbuilder = LayerBuilder::activation();
    actbuilder.type(neurax::hal::ActivationType::RELU);
    NeuralNetworkBuilder builder;
    builder.addLayer(actbuilder.build());
