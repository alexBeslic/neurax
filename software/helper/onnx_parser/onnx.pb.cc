...
PROTOBUF_CONSTEXPR NodeDeviceConfigurationProto::NodeDeviceConfigurationProto(
    ::_pbi::ConstantInitialized)
  : sharding_spec_()
  , configuration_id_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , pipeline_stage_(0){}
...
NodeDeviceConfigurationProto::NodeDeviceConfigurationProto(const NodeDeviceConfigurationProto& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  configuration_id_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    configuration_id_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_configuration_id()) {
    configuration_id_.Set(from._internal_configuration_id(), 
      GetArenaForAllocation());
  }
