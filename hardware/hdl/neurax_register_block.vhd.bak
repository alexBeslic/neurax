...
use work.neurax_accel_types_pkg.all;
...
entity neurax_register_block is
    ...
    port (
        ...
        -- Debug/monitoring
        neurax_debug_cycle_o  : out std_logic_vector(g_WIDTH-1 downto 0);
        neurax_status_o       : out std_logic_vector(7 downto 0)
    );
...
begin
    ...
    neurax_debug_cycle_o <= ram(to_integer(c_REG_DEBUG_CYCLES));
    neurax_status_o <= ram(to_integer(c_REG_DEBUG_STATUS))(t_DEBUG_STATUS);
end arch;