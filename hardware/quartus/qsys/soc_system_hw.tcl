...
proc compose { } {
    ...
    add_instance DMA_neurax_read altera_msgdma 24.1
    set_instance_parameter_value DMA_neurax_read {BURST_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_read {BURST_WRAPPING_SUPPORT} {0}
    set_instance_parameter_value DMA_neurax_read {CHANNEL_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_read {CHANNEL_WIDTH} {8}
    set_instance_parameter_value DMA_neurax_read {DATA_FIFO_DEPTH} {256}
    set_instance_parameter_value DMA_neurax_read {DATA_WIDTH} {32}
    set_instance_parameter_value DMA_neurax_read {DESCRIPTOR_FIFO_DEPTH} {128}
    set_instance_parameter_value DMA_neurax_read {ENHANCED_FEATURES} {0}
    set_instance_parameter_value DMA_neurax_read {ERROR_ENABLE} {1}
    set_instance_parameter_value DMA_neurax_read {ERROR_WIDTH} {1}
    set_instance_parameter_value DMA_neurax_read {EXPOSE_ST_PORT} {0}
    set_instance_parameter_value DMA_neurax_read {FIX_ADDRESS_WIDTH} {32}
    set_instance_parameter_value DMA_neurax_read {MAX_BURST_COUNT} {2}
    set_instance_parameter_value DMA_neurax_read {MAX_BYTE} {4096}
    set_instance_parameter_value DMA_neurax_read {MAX_STRIDE} {1}
    set_instance_parameter_value DMA_neurax_read {MODE} {2}
    set_instance_parameter_value DMA_neurax_read {PACKET_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_read {PREFETCHER_DATA_WIDTH} {32}
    set_instance_parameter_value DMA_neurax_read {PREFETCHER_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_read {PREFETCHER_MAX_READ_BURST_COUNT} {2}
    set_instance_parameter_value DMA_neurax_read {PREFETCHER_READ_BURST_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_read {PROGRAMMABLE_BURST_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_read {RESPONSE_PORT} {2}
    set_instance_parameter_value DMA_neurax_read {STRIDE_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_read {TRANSFER_TYPE} {Full Word Accesses Only}
    set_instance_parameter_value DMA_neurax_read {USE_FIX_ADDRESS_WIDTH} {0}

    add_instance DMA_neurax_write altera_msgdma 24.1
    set_instance_parameter_value DMA_neurax_write {BURST_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_write {BURST_WRAPPING_SUPPORT} {0}
    set_instance_parameter_value DMA_neurax_write {CHANNEL_ENABLE} {1}
    set_instance_parameter_value DMA_neurax_write {CHANNEL_WIDTH} {1}
    set_instance_parameter_value DMA_neurax_write {DATA_FIFO_DEPTH} {2048}
    set_instance_parameter_value DMA_neurax_write {DATA_WIDTH} {32}
    set_instance_parameter_value DMA_neurax_write {DESCRIPTOR_FIFO_DEPTH} {256}
    set_instance_parameter_value DMA_neurax_write {ENHANCED_FEATURES} {0}
    set_instance_parameter_value DMA_neurax_write {ERROR_ENABLE} {1}
    set_instance_parameter_value DMA_neurax_write {ERROR_WIDTH} {1}
    set_instance_parameter_value DMA_neurax_write {EXPOSE_ST_PORT} {0}
    set_instance_parameter_value DMA_neurax_write {FIX_ADDRESS_WIDTH} {32}
    set_instance_parameter_value DMA_neurax_write {MAX_BURST_COUNT} {2}
    set_instance_parameter_value DMA_neurax_write {MAX_BYTE} {4096}
    set_instance_parameter_value DMA_neurax_write {MAX_STRIDE} {1}
    set_instance_parameter_value DMA_neurax_write {MODE} {1}
    set_instance_parameter_value DMA_neurax_write {PACKET_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_write {PREFETCHER_DATA_WIDTH} {32}
    set_instance_parameter_value DMA_neurax_write {PREFETCHER_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_write {PREFETCHER_MAX_READ_BURST_COUNT} {2}
    set_instance_parameter_value DMA_neurax_write {PREFETCHER_READ_BURST_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_write {PROGRAMMABLE_BURST_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_write {RESPONSE_PORT} {2}
    set_instance_parameter_value DMA_neurax_write {STRIDE_ENABLE} {0}
    set_instance_parameter_value DMA_neurax_write {TRANSFER_TYPE} {Full Word Accesses Only}
    set_instance_parameter_value DMA_neurax_write {USE_FIX_ADDRESS_WIDTH} {0}
    ...
    add_instance hps_0 altera_hps 24.1
    ...
    set_instance_parameter_value hps_0 {F2SDRAM_Type} {Avalon-MM\ Read-Only Avalon-MM\ Write-Only}
    set_instance_parameter_value hps_0 {F2SDRAM_Width} {64 64}
    ...
    set_instance_parameter_value hps_0 {GPIO_Enable} {No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No Yes No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No}
    ...
    set_instance_parameter_value hps_0 {TIMING_TQHS} {400}
    ...
    add_instance neurax_avalon_accelerator_0 neurax_avalon_accelerator 1.0
    set_instance_parameter_value neurax_avalon_accelerator_0 {PARALLEL_UNITS} {4}
    set_instance_parameter_value neurax_avalon_accelerator_0 {g_ADDR_WIDTH} {4}
    set_instance_parameter_value neurax_avalon_accelerator_0 {g_FB_HEIGHT} {100}
    set_instance_parameter_value neurax_avalon_accelerator_0 {g_FB_WIDTH} {100}
    set_instance_parameter_value neurax_avalon_accelerator_0 {g_PIXEL_WIDTH} {24}
    set_instance_parameter_value neurax_avalon_accelerator_0 {g_WIDTH} {32}

    add_instance pll_0 altera_pll 24.1
    ...
    add_connection DMA_neurax_read.mm_write hps_0.f2h_sdram1_data avalon
    set_connection_parameter_value DMA_neurax_read.mm_write/hps_0.f2h_sdram1_data arbitrationPriority {1}
    set_connection_parameter_value DMA_neurax_read.mm_write/hps_0.f2h_sdram1_data baseAddress {0x0000}
    set_connection_parameter_value DMA_neurax_read.mm_write/hps_0.f2h_sdram1_data defaultConnection {0}

    add_connection DMA_neurax_write.mm_read hps_0.f2h_sdram0_data avalon
    set_connection_parameter_value DMA_neurax_write.mm_read/hps_0.f2h_sdram0_data arbitrationPriority {1}
    set_connection_parameter_value DMA_neurax_write.mm_read/hps_0.f2h_sdram0_data baseAddress {0x0000}
    set_connection_parameter_value DMA_neurax_write.mm_read/hps_0.f2h_sdram0_data defaultConnection {0}

    add_connection DMA_neurax_write.st_source neurax_avalon_accelerator_0.avalon_sink avalon_streaming

    add_connection clk_0.clk pll_0.refclk clock

    add_connection clk_0.clk_reset DMA_neurax_read.reset_n reset

    add_connection clk_0.clk_reset DMA_neurax_write.reset_n reset

    add_connection clk_0.clk_reset neurax_avalon_accelerator_0.reset reset

    add_connection clk_0.clk_reset pll_0.reset reset

    add_connection hps_0.f2h_irq0 DMA_neurax_read.csr_irq interrupt
    set_connection_parameter_value hps_0.f2h_irq0/DMA_neurax_read.csr_irq irqNumber {1}

    add_connection hps_0.f2h_irq0 DMA_neurax_write.csr_irq interrupt
    set_connection_parameter_value hps_0.f2h_irq0/DMA_neurax_write.csr_irq irqNumber {0}

    add_connection hps_0.h2f_lw_axi_master DMA_neurax_read.csr avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_read.csr arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_read.csr baseAddress {0x0080}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_read.csr defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master DMA_neurax_read.descriptor_slave avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_read.descriptor_slave arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_read.descriptor_slave baseAddress {0x0100}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_read.descriptor_slave defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master DMA_neurax_write.csr avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_write.csr arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_write.csr baseAddress {0x0040}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_write.csr defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master DMA_neurax_write.descriptor_slave avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_write.descriptor_slave arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_write.descriptor_slave baseAddress {0x0060}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/DMA_neurax_write.descriptor_slave defaultConnection {0}

    add_connection hps_0.h2f_lw_axi_master neurax_avalon_accelerator_0.avalon_slave_0 avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/neurax_avalon_accelerator_0.avalon_slave_0 arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/neurax_avalon_accelerator_0.avalon_slave_0 baseAddress {0x0000}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/neurax_avalon_accelerator_0.avalon_slave_0 defaultConnection {0}

    add_connection hps_0.h2f_reset DMA_neurax_read.reset_n reset

    add_connection hps_0.h2f_reset DMA_neurax_write.reset_n reset

    add_connection neurax_avalon_accelerator_0.avalon_source DMA_neurax_read.st_sink avalon_streaming

    add_connection pll_0.outclk0 DMA_neurax_read.clock clock

    add_connection pll_0.outclk0 DMA_neurax_write.clock clock

    add_connection pll_0.outclk0 hps_0.f2h_sdram0_clock clock

    add_connection pll_0.outclk0 hps_0.f2h_sdram1_clock clock

    add_connection pll_0.outclk0 hps_0.h2f_lw_axi_clock clock

    add_connection pll_0.outclk0 neurax_avalon_accelerator_0.clk clock

    # exported interfaces
    add_interface clk clock sink
    set_interface_property clk EXPORT_OF clk_0.clk_in
    add_interface hps_0_ddr conduit end
    set_interface_property hps_0_ddr EXPORT_OF hps_0.memory
    add_interface hps_0_io conduit end
    set_interface_property hps_0_io EXPORT_OF hps_0.hps_io
