...
add_connection DMA_neurax_read.mm_write hps_0.f2h_sdram1_data
...
add_connection DMA_neurax_write.mm_read hps_0.f2h_sdram0_data
...
add_connection DMA_neurax_write.st_source neurax_avalon_accelerator_0.avalon_sink

add_connection clk_0.clk pll_0.refclk

add_connection clk_0.clk_reset DMA_neurax_read.reset_n

add_connection clk_0.clk_reset DMA_neurax_write.reset_n

add_connection clk_0.clk_reset neurax_avalon_accelerator_0.reset

add_connection clk_0.clk_reset pll_0.reset

add_connection hps_0.f2h_irq0 DMA_neurax_read.csr_irq
set_connection_parameter_value hps_0.f2h_irq0/DMA_neurax_read.csr_irq irqNumber {1}

add_connection hps_0.f2h_irq0 DMA_neurax_write.csr_irq
set_connection_parameter_value hps_0.f2h_irq0/DMA_neurax_write.csr_irq irqNumber {0}

add_connection hps_0.h2f_lw_axi_master DMA_neurax_read.csr
...
add_connection hps_0.h2f_lw_axi_master DMA_neurax_read.descriptor_slave
...
add_connection hps_0.h2f_lw_axi_master DMA_neurax_write.csr
...
add_connection hps_0.h2f_lw_axi_master DMA_neurax_write.descriptor_slave
...
add_connection hps_0.h2f_lw_axi_master neurax_avalon_accelerator_0.avalon_slave_0
...
add_connection hps_0.h2f_reset DMA_neurax_read.reset_n

add_connection hps_0.h2f_reset DMA_neurax_write.reset_n

add_connection neurax_avalon_accelerator_0.avalon_source DMA_neurax_read.st_sink

add_connection pll_0.outclk0 DMA_neurax_read.clock

add_connection pll_0.outclk0 DMA_neurax_write.clock

add_connection pll_0.outclk0 hps_0.f2h_sdram0_clock

add_connection pll_0.outclk0 hps_0.f2h_sdram1_clock

add_connection pll_0.outclk0 hps_0.h2f_lw_axi_clock

add_connection pll_0.outclk0 neurax_avalon_accelerator_0.clk
