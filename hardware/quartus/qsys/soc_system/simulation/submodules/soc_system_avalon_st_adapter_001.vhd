-- soc_system_avalon_st_adapter_001.vhd
...
entity soc_system_avalon_st_adapter_001 is
	generic (
		inBitsPerSymbol : integer := 8;
		inUsePackets    : integer := 0;
		inDataWidth     : integer := 32;
		inChannelWidth  : integer := 1;
		inErrorWidth    : integer := 1;
	...
	port (
		...
		in_0_error     : in  std_logic                     := '0';             --         .error
		in_0_channel   : in  std_logic                     := '0';             --         .channel
...
end entity soc_system_avalon_st_adapter_001;

architecture rtl of soc_system_avalon_st_adapter_001 is
	component soc_system_avalon_st_adapter_001_channel_adapter_0 is
		port (
	...
	end component soc_system_avalon_st_adapter_001_channel_adapter_0;
...
begin
	...
	inchannelwidth_check : if inChannelWidth /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	inerrorwidth_check : if inErrorWidth /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	channel_adapter_0 : component soc_system_avalon_st_adapter_001_channel_adapter_0
		port map (
...
end architecture rtl; -- of soc_system_avalon_st_adapter_001
