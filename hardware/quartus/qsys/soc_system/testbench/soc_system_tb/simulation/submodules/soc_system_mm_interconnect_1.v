...
module soc_system_mm_interconnect_1 (
	...
	wire          rsp_mux_001_src_valid;                                                 // rsp_mux_001:src_valid -> dma_0_write_master_agent:rp_valid
	wire  [115:0] rsp_mux_001_src_data;                                                  // rsp_mux_001:src_data -> dma_0_write_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                 // dma_0_write_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                               // rsp_mux_001:src_channel -> dma_0_write_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                         // rsp_mux_001:src_startofpacket -> dma_0_write_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                           // rsp_mux_001:src_endofpacket -> dma_0_write_master_agent:rp_endofpacket
	...
	wire  [115:0] dma_0_read_master_agent_cp_data;                                       // dma_0_read_master_agent:cp_data -> router:sink_data
	...
	wire          dma_0_write_master_agent_cp_valid;                                     // dma_0_write_master_agent:cp_valid -> router_001:sink_valid
	wire  [115:0] dma_0_write_master_agent_cp_data;                                      // dma_0_write_master_agent:cp_data -> router_001:sink_data
	wire          dma_0_write_master_agent_cp_ready;                                     // router_001:sink_ready -> dma_0_write_master_agent:cp_ready
	wire          dma_0_write_master_agent_cp_startofpacket;                             // dma_0_write_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          dma_0_write_master_agent_cp_endofpacket;                               // dma_0_write_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [115:0] router_src_data;                                                       // router:src_data -> dma_0_read_master_limiter:cmd_sink_data
	...
	wire  [115:0] dma_0_read_master_limiter_cmd_src_data;                                // dma_0_read_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [115:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> dma_0_read_master_limiter:rsp_sink_data
	...
	wire  [115:0] dma_0_read_master_limiter_rsp_src_data;                                // dma_0_read_master_limiter:rsp_src_data -> dma_0_read_master_agent:rp_data
